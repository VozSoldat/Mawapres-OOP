...
<head>
    ...
    <meta property="og:image" content="/tatib/images/logo.svg" />
    <meta name="twitter:title" content="<?php echo $judul; ?>" />
    <meta name="twitter:description" content="<?php echo $deskripsi; ?>" />
    <meta name="twitter:image" content="/tatib/images/logo.svg" />
    <title><?php echo $judul; ?></title>
    <link rel="icon" href="/tatib/images/logo.svg" />
...
<body class="mx-auto overflow-x-hidden bg-amber-50/75">
    <?php
    if (!$halaman_khusus) include 'public/sidebar/mahasiswa.php';
    ?>
